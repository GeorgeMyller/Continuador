...
class ModernUI:
    ...
    def _create_interface(self) -> None:
        ...
        main_container.pack(
            fill=tk.BOTH, expand=True, padx=UI_CONFIG["padding"], pady=UI_CONFIG["padding"]
        )
    ...
    def _create_card(
        self, parent: tk.Widget, title: str, height: Optional[int] = None
    ) -> tk.Widget:
        """
    ...
    def _create_status_card(self, parent: tk.Widget) -> None:
        ...
        # Tempo de sessão
        self._create_counter_row(
            content, "Tempo:", "session_time_label", default_value="00:00", top_margin=15
        )

    def _create_counter_row(
        self,
        parent: tk.Widget,
        label: str,
        attr_name: str,
        ...
        label_widget = tk.Label(
            ...
            font=(
                ...
                18 if attr_name == "click_counter_label" else 14,
                "bold",
            ),
            fg=self.colors["primary"],
            bg=self.colors["card_bg"],
    ...
    def _create_stats_card(self, parent: tk.Widget) -> None:
        ...
        self._create_stat_row(
            content, "Taxa de Sucesso:", "success_rate_label", "N/A", self.colors["success"]
        )

        # Tempo médio
        self._create_stat_row(
            content, "Tempo Médio:", "avg_time_label", "N/A", self.colors["primary"], top_margin=15
        )
